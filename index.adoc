...
=== Me at https://mpi-cbg.de[MPI CBG] / https://scionics.de[Scionics]

image:x600px-MPI-CBG_building_outside_4pl.jpg[width=55%]

[.XL-text]
**Scientific Compitung Facility**: Bioinformatics, Bio-Image-Analysis, HPC Cluster Support, Software Engineering, Hardware Control, Data Science/ML, Data Management, ELNs, ...
...
https://github.com/psteinb/adversarial-medical-imaging-imb[github.com/psteinb/adversarial-medical-imaging-imb]
--
...
- trust in any (Deep Learning) classifiers?
...
* successfully achieved reproducibility of paper results
(praise to the authors!)
* illustrated classifiers and attacks appear remote to reality
(downscaling to 224x224, inbalanced dataset)
* portions of the paper contradictory in the details
(white vs. grey vs. black box attacks)
* https://github.com/sgfin/adversarial-medicine/issues/4#issue-466383100[contacted] authors to resolve outstanding issues, offered (https://github.com/sgfin/adversarial-medicine/issues/4#issuecomment-510145783)[co-authorship]
